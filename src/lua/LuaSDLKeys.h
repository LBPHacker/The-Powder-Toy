...
#define LCONSTANDAS(k, v) LCONST(v); lua_pushinteger(L, int(v)); lua_setfield(L, -2, k)
	...
	LCONST(SDLK_SPACE);
	LCONST(SDLK_EXCLAIM);
	LCONSTANDAS("SDLK_QUOTEDBL", SDLK_DBLAPOSTROPHE);
	LCONST(SDLK_HASH);
	LCONST(SDLK_PERCENT);
	LCONST(SDLK_DOLLAR);
	LCONST(SDLK_AMPERSAND);
	LCONSTANDAS("SDLK_QUOTE", SDLK_APOSTROPHE);
	...
	LCONSTANDAS("SDLK_BACKQUOTE", SDLK_GRAVE);
	LCONST(SDLK_a);
	LCONST(SDLK_b);
	LCONST(SDLK_c);
	LCONST(SDLK_d);
	...
	LCONSTANDAS("KMOD_NONE"  , SDL_KMOD_NONE);
	LCONSTANDAS("KMOD_LSHIFT", SDL_KMOD_LSHIFT);
	LCONSTANDAS("KMOD_RSHIFT", SDL_KMOD_RSHIFT);
	LCONSTANDAS("KMOD_LCTRL" , SDL_KMOD_LCTRL);
	LCONSTANDAS("KMOD_RCTRL" , SDL_KMOD_RCTRL);
	LCONSTANDAS("KMOD_LALT"  , SDL_KMOD_LALT);
	LCONSTANDAS("KMOD_RALT"  , SDL_KMOD_RALT);
	LCONSTANDAS("KMOD_LGUI"  , SDL_KMOD_LGUI);
	LCONSTANDAS("KMOD_RGUI"  , SDL_KMOD_RGUI);
	LCONSTANDAS("KMOD_NUM"   , SDL_KMOD_NUM);
	LCONSTANDAS("KMOD_CAPS"  , SDL_KMOD_CAPS);
	LCONSTANDAS("KMOD_MODE"  , SDL_KMOD_MODE);
	LCONSTANDAS("KMOD_CTRL"  , SDL_KMOD_CTRL);
	LCONSTANDAS("KMOD_SHIFT" , SDL_KMOD_SHIFT);
	LCONSTANDAS("KMOD_ALT"   , SDL_KMOD_ALT);
	LCONSTANDAS("KMOD_GUI"   , SDL_KMOD_GUI);
