...
int LuaScriptInterface::graphics_drawText(lua_State * l)
{
	...
	gui::SDLWindow::Ref().DrawText(gui::Point{ x, y }, ByteString(text).FromUtf8(), gui::Color{ r, g, b, a });
	return 0;
}
...
int LuaScriptInterface::graphics_drawRect(lua_State * l)
{
	...
	gui::SDLWindow::Ref().DrawRectOutline(gui::Rect{ gui::Point{ x, y }, gui::Point{ width, height } }, gui::Color{ r, g, b, a });
	return 0;
}
...
int LuaScriptInterface::graphics_fillRect(lua_State * l)
{
	...
	gui::SDLWindow::Ref().DrawRect(gui::Rect{ gui::Point{ x, y }, gui::Point{ width, height } }, gui::Color{ r, g, b, a });
	return 0;
}
