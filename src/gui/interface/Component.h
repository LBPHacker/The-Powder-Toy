...
public:
	...
	inline Window *const GetParentWindow() const
	{
		return parentstate_;
	}
	 ...
	 * If new_parent is NULL, this component will have no parent. (THIS DOES NOT delete THE COMPONENT. See
	 * XComponent::RemoveChild)
	 */
	void SetParentWindow(Window *window);
	void SetParent(Panel *new_parent);

	// Get the parent component.
	inline Panel *const GetParent() const
	{
		return _parent;
	}
