...
std::optional<std::pair<int, String>>
	PropertyWindow::TakePropertyFrom(const Simulation *sim, std::optional<int> i) const
{
...
void PropertyTool::Draw(Simulation *sim, const Brush &cBrush, ui::Point position)
{
...
void PropertyTool::DrawLine(
	Simulation *sim, const Brush &cBrush, ui::Point position, ui::Point position2, bool dragging
)
{
...
void PropertyTool::DrawRect(Simulation *sim, const Brush &cBrush, ui::Point position, ui::Point position2)
{
	int x1 = position.X, y1 = position.Y, x2 = position2.X, y2 = position2.Y;
	int i, j;
	if (x1 > x2)
...
void PropertyTool::DrawFill(Simulation *sim, const Brush &cBrush, ui::Point position)
{
	if (configuration)
	{
