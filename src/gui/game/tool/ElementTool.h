...
public:
	...
	ElementTool(int id, ByteString identifier) :
		Tool(id, identifier)
	{
	}
...
{
public:
	Element_LIGH_Tool(int id, ByteString identifier) :
		ElementTool(id, identifier)
	{
	}
...
{
public:
	Element_TESC_Tool(int id, ByteString identifier) :
		ElementTool(id, identifier)
	{
	}
...
{
public:
	PlopTool(int id, ByteString identifier) :
		ElementTool(id, identifier)
	{
	}
