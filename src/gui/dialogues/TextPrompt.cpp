...
TextPrompt::TextPrompt(
	String title, String message, String text, String placeholder, bool multiline, TextDialogueCallback callback_
) :
	...
	callback(callback_)
{
	...
	textField = new ui::Textbox(
		ui::Point(4, messageLabel->Position.Y + messageLabel->Size.Y + 7), ui::Point(Size.X - 8, 16), text, placeholder
	);
	if (multiline)
	{
