...
public:
	...
	// sample_low/sample_high - Clamp output samples to specified range, or disable clamping if sample_low >=
	// sample_high Pclist_x/Pclist_y - Optional pointers to contributor lists from another instance of a Resampler
