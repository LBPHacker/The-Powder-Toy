...
namespace Powder::Activity
{
	class OnlineBrowser : public Browser
	{
		...
		bool GuiSaveButtonSubtitle(Item &item, bool saveButtonHovered) final override;
		void GuiSaveButtonThumbnailRight(Item &item, bool saveButtonHovered) final override;
		void GuiSaveButtonContextmenu(Item &item) final override;
