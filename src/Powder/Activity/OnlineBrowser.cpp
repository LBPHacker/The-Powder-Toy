...
namespace Powder::Activity
{
	...
	bool OnlineBrowser::GuiSaveButtonSubtitle(Item &item, bool saveButtonHovered)
	{
		auto &onlineItem = static_cast<OnlineItem &>(item);
	...
	void OnlineBrowser::GuiSaveButtonThumbnailRight(Item &item, bool saveButtonHovered)
	{
		auto &onlineItem = static_cast<OnlineItem &>(item);
	...
	void OnlineBrowser::GuiSaveButtonContextmenu(Item &item)
	{
		auto &onlineItem = static_cast<OnlineItem &>(item);
