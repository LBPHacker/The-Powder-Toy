...
namespace Powder::Activity
{
	...
	void OnlineBrowser::GuiSearchLeft()
	{
		...
		DropdownItem(ByteString::Build(Gui::iconPowder    , " Public"   )); // TODO-REDO_UI-TRANSLATE
	...
	void OnlineBrowser::GuiSearchRight()
	{
		...
		SetSize(GetHost().GetCommonMetrics().bigButton);
		SetTextPadding(dropdownTextPadding, 0);
		DropdownItem("All time"  ); // TODO-REDO_UI-TRANSLATE
		DropdownItem("Today"     ); // TODO-REDO_UI-TRANSLATE
		DropdownItem("This week" ); // TODO-REDO_UI-TRANSLATE
		DropdownItem("This month"); // TODO-REDO_UI-TRANSLATE
		DropdownItem("This year" ); // TODO-REDO_UI-TRANSLATE
		if (EndDropdown())
		{
			SetQuery({ 0, query.str });
			FocusQuery();
