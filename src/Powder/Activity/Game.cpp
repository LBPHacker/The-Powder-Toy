...
namespace Powder::Activity
{
	...
	void Game::GuiQuickOptions()
	{
		...
		if (quickOption("ambientheat", "G", GetAmbientHeat() ? ButtonFlags::stuck : ButtonFlags::none, "Draw gravity field")) // TODO-REDO_UI-TRANSLATE
		{
		...
		if (quickOption("drawgravity", "N", GetDrawGravity() ? ButtonFlags::stuck : ButtonFlags::none, "Enable newtonian gravity")) // TODO-REDO_UI-TRANSLATE
		{
			ToggleDrawGravityAction();
		}
		if (quickOption("newtoniangravity", "A", GetNewtonianGravity() ? ButtonFlags::stuck : ButtonFlags::none, "Enable ambient heat")) // TODO-REDO_UI-TRANSLATE
		{
	...
	void Game::VisualLog(std::string message)
	{
		...
		logEntries.push_back(LogEntry{ { Gui::TargetAnimation<int32_t>::LinearProfile{ 170 }, 0, 600 }, std::move(message) });
