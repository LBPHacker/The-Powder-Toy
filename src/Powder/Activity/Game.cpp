...
namespace Powder::Activity
{
	...
	float Game::GetEdgePressure() const
	{
		return simulation->air->edgePressure;
	}

	void Game::SetEdgePressure(float newEdgePressure)
	{
		simulation->air->edgePressure = newEdgePressure;
	}
