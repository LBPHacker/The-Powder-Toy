...
namespace Powder::Activity
{
	...
	private:
		...
		Gui::TargetAnimation<int32_t> toolTipAlpha{ Gui::TargetAnimation<int32_t>::LinearProfile{ 400, 200 } };
		...
		Gui::TargetAnimation<int32_t> infoTipAlpha{ Gui::TargetAnimation<int32_t>::LinearProfile{ 400, 200 } };
		std::optional<InfoTipInfo> infoTipInfo;
		void QueueInfoTip(std::string message);
		void DrawInfoTip();

		std::string introText;
		Gui::TargetAnimation<int32_t> introTextAlpha{ Gui::TargetAnimation<int32_t>::LinearProfile{ 300 } };
		void DrawIntroText();
