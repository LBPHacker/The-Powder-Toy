...
namespace Powder::Activity
{
	...
	public:
		static constexpr char actionNamePrefix[]         = "DEFAULT_ACTION_";
		static constexpr char actionCategoryNamePrefix[] = "DEFAULT_ACTIONCATEGORY_";
		static constexpr char actionGroupNamePrefix[]    = "DEFAULT_ACTIONGROUP_";
		static constexpr char actionContextNamePrefix[]  = "DEFAULT_ACTIONCONTEXT_";
		...
		static constexpr ToolSlotIndex toolSlotCount = 4;
	...
	private:
		...
		bool toolSizeLogarithmic = false;
	...
	public:
		...
		float GetEdgePressure() const;
		void SetEdgePressure(float newEdgePressure);
		...
		struct ShortcutMapperInfo
		{
			...
			std::vector<std::shared_ptr<ActionCategory>> categories;
