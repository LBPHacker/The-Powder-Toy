...
namespace Powder::Activity
{
	...
	Property::CanApplyKind Property::CanApply() const
	{
		if (configuration)
		{
	...
	void Property::Gui()
	{
		BeginDialog("propertytool", "\biEdit property", GetHost().GetSize().OriginRect(), dialogWidth); // TODO-REDO_UI-TRANSLATE
		{
			...
			BeginTextbox("propvalue", propValueStr, "[value]", TextboxFlags::none, (configuration ? Gui::colorWhite : Gui::colorRed).WithAlpha(255));
			SetSize(Common{});
			if (focusPropValue)
			{
				GiveInputFocus();
