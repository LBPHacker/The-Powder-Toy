...
namespace Powder::Activity
{
	...
	protected:
		...
		Size2 GetSmallThumbnailSize() const;
		Size2 GetOriginalThumbnailSize() const;
	...
	private:
		...
		std::optional<Rect> GuiSaveButton(int32_t index, Item &item);
		virtual bool GuiSaveButtonSubtitle(Item &item, bool saveButtonHovered); // No need to call this from overriding functions.
		virtual void GuiSaveButtonThumbnailRight(Item &item, bool saveButtonHovered); // No need to call this from overriding functions.
		virtual void GuiSaveButtonContextmenu(Item &item); // No need to call this from overriding functions.
