...
// e.g. If a reaction has n chances of occurring, each time with probability p, this returns the probability that it
...
public:
	...
	// Note: maxK must be small, otherwise the method used in this class is inefficient. (n and p can be any valid
	// value)
