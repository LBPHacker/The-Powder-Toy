...
#define UPDATE_FUNC_ARGS Simulation* sim, int i, int x, int y, int surround_space, int nt, Parts &parts, int pmap[YRES][XRES_ALIGNED]
...
constexpr int INFINITE_NEIGHBORHOOD = -1;
