...
#define UPDATE_FUNC_ARGS Simulation* sim, int i, int x, int y, int surround_space, int nt, std::vector<Particle> &parts, PlaneAdapter<std::vector<int>, XRESExtent, YRESExtent> &pmap
