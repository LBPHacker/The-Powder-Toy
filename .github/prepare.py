...
#	(  'x86_64',    'windows',      'mingw', 'dynamic',   'linux', 'ubuntu-20.04',     '',   False,    False,      None,         None,                    None, 'release',       10 ), # ubuntu-20.04 doesn't have ucrt64-capable mingw >_>
	...
	( 'aarch64',    'windows',       'msvc',  'static', 'windows', 'windows-2019', '.exe',   False,    False,      None,         None,                    None,   'debug',        0 ), # priority = 0: rarely used aarch64 windows build
	( 'aarch64',    'windows',       'msvc',  'static', 'windows', 'windows-2019', '.exe',   False,    False,    '.pdb',         None,                    None, 'release',        0 ), # priority = 0: rarely used aarch64 windows build
	( 'aarch64',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2019', '.exe',   False,    False,      None,         None,                    None,   'debug',        0 ), # priority = 0: rarely used aarch64 windows build
	( 'aarch64',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2019', '.exe',   False,    False,      None,         None,                    None, 'release',        0 ), # priority = 0: rarely used aarch64 windows build
