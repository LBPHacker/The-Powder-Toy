...
#	(     'x86',    'windows',      'mingw',  'static', 'windows', 'windows-2022', '.exe',       'publish',    '.dbg',         None,  'i686-win-mingw-static', 'release',       10, False ), # windows xp, mingw32 is dead
#	( 'x86_old',    'windows',      'mingw',  'static', 'windows', 'windows-2022', '.exe',       'archive',    '.dbg',         None,                     None, 'release',       10, False ), # windows xp, mingw32 is dead
	...
	(  'x86_64',    'windows',       'msvc',  'static', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None,   'debug',        0, False ), # priority = 0: static debug build
	(  'x86_64',    'windows',       'msvc',  'static', 'windows', 'windows-2025-vs2026', '.exe',       'archive',    '.pdb',         None, 'x86_64-win-msvc-static', 'release',       10, False ),
	(  'x86_64',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None,   'debug',       10, False ),
#	(  'x86_64',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,  'backendvs',                     None,   'debug',        0, False ), # priority = 0: backend=vs build
	(  'x86_64',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None, 'release',       10, False ),
	(     'x86',    'windows',       'msvc',  'static', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None,   'debug',        0, False ), # priority = 0: static debug build
	(     'x86',    'windows',       'msvc',  'static', 'windows', 'windows-2025-vs2026', '.exe',       'archive',    '.pdb',         None,                     None, 'release',       10, False ),
	(     'x86',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None,   'debug',       10, False ),
	(     'x86',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None, 'release',       10, False ),
	( 'aarch64',    'windows',       'msvc',  'static', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None,   'debug',        0, False ), # priority = 0: static debug build
	( 'aarch64',    'windows',       'msvc',  'static', 'windows', 'windows-2025-vs2026', '.exe',       'publish',    '.pdb',         None,  'arm64-win-msvc-static', 'release',       10, False ),
	( 'aarch64',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None,   'debug',       10, False ),
	( 'aarch64',    'windows',       'msvc', 'dynamic', 'windows', 'windows-2025-vs2026', '.exe',         'check',      None,         None,                     None, 'release',       10, False ),
